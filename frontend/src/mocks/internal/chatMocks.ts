...
export const MOCK_RESPONSES: Record<string, ChatResponse> = {
  'Quais exames estão pendentes?': {
    ...
    sources: ['[1] PCDT Artrite Psoriásica — CONITEC 2023'],
    reasoning: [
  ...
  'Há contraindicação ao metotrexato neste paciente?': {
    ...
    sources: [
      '[1] PCDT Artrite Psoriásica — CONITEC 2023',
      '[2] Bula Metotrexato — ANVISA (mock)',
    ],
    reasoning: [
  ...
  'Resumir o caso clínico atual': {
    ...
    sources: ['[1] Prontuário resumido (mock)'],
  ...
  'Bundle de sepse está completo?': {
    ...
    sources: ['[1] Protocolo de Sepse — MS 2019'],
  ...
  'Há alertas ativos?': {
    ...
    sources: ['[1] Sistema de alertas (mock)'],
  ...
  'Qual a ação sugerida?': {
    ...
    sources: ['[1] Motor de sugestão (mock)'],
